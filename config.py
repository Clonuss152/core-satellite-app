...
CORE_TARGET_WEIGHT = 0.90
CORE_REBALANCE_DAYS = 10

SAT_REBALANCE_DAYS = 17

SATELLITE_A_WEIGHT = 0.05
SATELLITE_A_TARGET_LEVERAGE = 10.0
SATELLITE_A_SELL_BUFFER = 6

SATELLITE_B_WEIGHT = 0.05
SATELLITE_B_TARGET_LEVERAGE = 7.0
SATELLITE_B_SELL_BUFFER = 6

NO_DUPLICATE_SATELLITES = True
WEAK_FLAT_SATELLITES = True
